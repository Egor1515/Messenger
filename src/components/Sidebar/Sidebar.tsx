  ...
  return (
    ...
    <aside className="flex border border-r-1" >
      <div className="flex flex-col items-center w-16 h-screen py-8 space-y-8 bg-white dark:bg-white-900 dark:border-gray-700">
        ...
        <a onClick={() => handleButtonClick('home')} href="" className="focus:bg-orange-600 focus:text-white text-orange-500 p-1.5 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-white-800 hover:bg-white-100">
        ...
        <a onClick={() => handleButtonClick('create-post')} href="" className="focus:bg-orange-600 focus:text-white text-orange-500 p-1.5 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-white-800 hover:bg-white-100">
          <i className="fa-solid fa-plus"></i>
        </a>


        <a onClick={() => handleButtonClick('notifications')} href="" className="p-1.5 focus:bg-orange-600 focus:text-white text-orange-500 p-1.5 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-white-800 hover:bg-white-100">
          <i className="fa-regular fa-image"></i>
        </a>

        <a onClick={() => handleButtonClick('chats')} href="" className="focus:bg-orange-600 focus:text-white text-orange-500 p-1.5 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-white-800 hover:bg-white-100">
          <i className="fa-regular fa-comments"></i>
        </a>

        <a onClick={() => handleButtonClick('settings')} href="" className="p-1.5 focus:bg-orange-600 focus:text-white text-orange-500 p-1.5 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-white-800 hover:bg-white-100">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
        ...
        <a onClick={() => { AuthService.isAuthorized() ? handleButtonClick('home') : handleButtonClick('login') }} href="" className="focus:bg-orange-600 focus:text-white text-orange-500 p-1.5 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-white-800 hover:bg-white-100">
      ...
      <div className="h-screen py-8 overflow-y-auto bg-white border-l border-r sm:w-64 w-60 dark:bg-white-900 dark:border-gray-700">
        ...
        <div className="ml-5  h-1 w-16 bg-orange-500 rounded"></div>
