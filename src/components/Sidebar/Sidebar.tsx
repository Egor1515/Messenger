  ...
  return (
    ...
    <aside className="flex border border-r-1" >
      <div className="flex flex-col items-center w-16 h-screen py-8 space-y-8 bg-white dark:bg-gray-900 dark:border-gray-700">
        ...
        <a onClick={() => handleButtonClick('create-post')} href="" className="focus:bg-teal-600 focus:text-white text-teal-600 p-1.5 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100">
        ...
        <a onClick={() => handleButtonClick('login')} href="" className="focus:bg-teal-600 focus:text-white text-teal-600 p-1.5 focus:outline-nones transition-colors duration-200 rounded-lg dark:text-gray-400 dark:hover:bg-gray-800 hover:bg-gray-100">
