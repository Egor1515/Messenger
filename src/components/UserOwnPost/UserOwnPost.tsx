    ...
    return (
        <div className="flex  w-full h-full">
            <div className="w-full h-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-white-800">
                <img className="object-cover object-center w-full h-2/4 rounded mt-4" src={userData?.avatarUrl} alt="avatar" />
                ...
                <button onClick={() => {navigate('/my-posts')}}
                    className="middle none center w-full rounded-lg bg-orange-500 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                ...
                <div className="px-6 py-4">
                    {userData ? (
                        <>
                            ...
                            <p className="py-2 text-gray-700 dark:text-gray-400">{userData.bio}</p>
                            <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                ...
                                <h1 className="px-2 text-sm">{userData.job}</h1>
                            </div>
                            ...
                            <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                ...
                                <h1 className="px-2 text-sm">{userData.location}</h1>
                            </div>
