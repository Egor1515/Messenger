        ...
        <div className="flex  w-full h-full">
            <div className="w-full h-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-white-800">
                ...
                <button onClick={() => {navigate('/my-posts')}}
                    className="middle none center w-full rounded-lg bg-emerald-500 py-3 px-6 font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                    ...
                    {userData ? (
                        <>
                            ...
                            <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                <svg aria-label="suitcase icon" className="w-6 h-6 fill-current text-emerald-500" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                <svg aria-label="location pin icon" className="text-emerald-500 w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex items-center mt-4 text-gray-700 dark:text-gray-200">
                                <svg aria-label="email icon" className="text-emerald-500 w-6 h-6 fill-current" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
