                    ...
                    <tbody>
                        {earningData.map((data, index) => (
                            <tr key={index}>
                                ...
                                <td className="py-2 px-4 border-b border-b-gray-50">
                                    <span className="text-[13px] font-medium text-emerald-500">{data.earning}</span>
                                </td>
                                <td className="py-2 px-4 border-b border-b-gray-50">
                                    <span className={`inline-block p-1 rounded ${data.status === 'Pending' ? 'bg-yellow-500' : 'bg-emerald-500'}/10 text-emerald-500 font-medium text-[12px] leading-none`}>{data.status}</span>
                                </td>
                            </tr>
                        ))}
                    </tbody>
