    ...
    return (
        <form className="">
            ...
            <div className="flex items-center px-3 py-2 rounded-lg bg-white-50 dark:bg-white-700">
                ...
                <textarea id="chat" rows={1} className="outline-emerald-200 block mx-4 p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-emerald-500 focus:border-emerald-500 dark:bg-white-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-emerald-500 dark:focus:border-emerald-500" placeholder="Your message..."></textarea>
                <button type="submit" className="inline-flex justify-center p-2 text-emerald-600 rounded-full cursor-pointer hover:bg-emerald-100 dark:text-emerald-500 dark:hover:bg-white-600">
                    <svg className="text-emerald-500 w-5 h-5 rotate-90 rtl:-rotate-90" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 20">
